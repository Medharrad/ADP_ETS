...
const FR: Dict = {
  ...
  "auth.tagline":
    "Gymnastique Artistique · DI-GYM · ADP 2026. Diagnostiquez votre classe, ciblez les axes prioritaires et générez un cycle différencié — sans note.",
  "auth.badge": "Outil sans note — Gymnastique Artistique",
  "auth.headlineLead": "Décidez avec",
  "auth.headlineAccent": "clarté",
  "auth.feat1": "Diagnostic des 3 observables, sans note",
  ...
  "dash.subtitle": "Vos classes, diagnostics et cycles de Gymnastique Artistique.",
...
const AR: Dict = {
  ...
  "auth.tagline":
    "الجمباز الفني · DI-GYM · ADP 2026. شخّص قسمك، حدّد المحاور ذات الأولوية، وولّد دورة متمايزة — بدون نقطة.",
  "auth.badge": "أداة بدون نقطة — الجمباز الفني",
  "auth.headlineLead": "قرّر بكل",
  "auth.headlineAccent": "وضوح",
  "auth.feat1": "تشخيص المؤشرات الثلاثة، بدون نقطة",
  ...
  "dash.subtitle": "أقسامك وتشخيصاتك ودورات الجمباز الفني.",
